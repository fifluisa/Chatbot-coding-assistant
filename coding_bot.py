...
class BotHandler(object):
    """
        ...
        It has tree main functions:
            ...
            'send_message' – sends new message to user
            'get_answer' — generates most relevant answer to user's question
    """
    ...
    def get_answer(self, question):
        if question == '/start':
            return "Hi, I am your stackoverflow bot. How can I help you today?"
            ...
            if "message" in update:
                ...
                if "text" in update["message"]:
                    ...
                    if is_unicode(text):
                        ...
                        bot.send_message(chat_id, "Hmm, you are sending me characters I can't recognize...")
